<template>
    <div role="slider" :aria-valuemin="0" :aria-valuemax="props.ratingCount" :aria-valuenow="selectedRating"
        :style="cssVars" class="average-rating" @mousemove="handleMouseMove" @mouseleave="handleMouseLeave"
